        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                function updatePlotNumber() {
                    ...
                    plotNumSelect.innerHTML = '<option value="" selected disabled>Select Plot Number</option>';
                    ...
                    deceaseNameSelect.innerHTML = '<option value="" selected disabled>Select Deceased Name</option>'; 
